        ...
        links: [
            {
                ...
                linkDescription:
                    'Upload your own autonomous racing model here and get started racing!',
...
export const GetTypeOfEventNameFromId = (id: string | undefined): string | undefined => {
    if (!id) return;
...
export const GetTypeOfEventOptionFromId = (
    id: string | undefined
