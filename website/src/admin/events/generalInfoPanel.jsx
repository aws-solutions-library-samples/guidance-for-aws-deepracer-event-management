            ...
            <SpaceBetween size="l">
                ...
                >
                    <Select
                        ...
                        onChange={({ detail }) =>
                            onChange({ typeOfEvent: detail.selectedOption.value })
                        }
                ...
                <FormField
                    label={t('events.event-date')}
                    description={t('events.event-date-descriprion')}
                >
                    <DatePicker
                        ...
                        openCalendarAriaLabel={(selectedDate) =>
                            ...
                            (selectedDate
                                ? `, ` + t('events.event-date-selected') + ` ${selectedDate}`
                                : '')
                        }
                ...
                >
                    <Select
                        ...
                        onChange={({ detail }) =>
                            onChange({ countryCode: detail.selectedOption.value })
                        }
