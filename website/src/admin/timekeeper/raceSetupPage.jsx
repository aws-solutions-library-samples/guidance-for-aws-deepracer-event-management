...
export const RaceSetupPage = ({
  ...
  return (
    <PageLayout breadcrumbs={breadcrumbs} header="Race Setup" description="Configure the race">
      <SpaceBetween direction="vertical" size="l">
        <Container header={<Header>Event & Track Selection</Header>}>
        ...
        <Container header={<Header>Racer Selection</Header>}>
          <Grid gridDefinition={[{ colspan: 7 }, { colspan: 3 }]}>
        ...
        <Box float="right">
          <SpaceBetween direction="horizontal" size="L">
            ...
            <Button
              ...
              onClick={() => {
                onNext({ race: race, config: selectedEvent.tracks[race.trackId - 1].raceConfig });
              }}
            >
              {t('button.next')}
            </Button>
