...
export class LandingPageManager extends Construct {
  ...
  constructor(scope: Construct, id: string, props: LandingPageManagerProps) {
    ...
    const copyLandingPageConfigLambda = new StandardLambdaPythonFunction(this, 'copyLandingPageConfig', {
      entry: 'lib/lambdas/copy_landing_page_config_from_event/',
      description: 'Copy landing page configs from events table to landing pages config table.',
      index: 'index.py',
