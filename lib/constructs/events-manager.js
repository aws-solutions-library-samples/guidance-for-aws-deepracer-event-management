...
class EventsManager extends constructs_1.Construct {
    constructor(scope, id, props) {
        ...
        const events_data_source = props.appsyncApi.api.addLambdaDataSource("EventsDataSource", events_handler);
        // Define API Schema
        ...
        // Event methods
        props.appsyncApi.schema.addQuery("getAllEvents", new awscdk_appsync_utils_1.ResolvableField({
            returnType: events_object_Type.attribute({ isList: true }),
            dataSource: events_data_source,
        }));
        props.appsyncApi.schema.addMutation("addEvent", new awscdk_appsync_utils_1.ResolvableField({
            args: {
        ...
        props.appsyncApi.schema.addSubscription("onAddedEvent", new awscdk_appsync_utils_1.ResolvableField({
            returnType: events_object_Type.attribute(),
        ...
        props.appsyncApi.schema.addMutation("deleteEvents", new awscdk_appsync_utils_1.ResolvableField({
            args: { "eventIds": awscdk_appsync_utils_1.GraphqlType.string({ isRequiredList: true }) },
            returnType: events_object_Type.attribute({ isList: true }),
            dataSource: events_data_source,
        }));
        props.appsyncApi.schema.addSubscription("onDeletedEvents", new awscdk_appsync_utils_1.ResolvableField({
            returnType: events_object_Type.attribute({ isList: true }),
            dataSource: props.appsyncApi.noneDataSource,
            requestMappingTemplate: appsync.MappingTemplate.fromString(`{
                        "version": "2017-02-28",
        ...
        props.appsyncApi.schema.addMutation("updateEvent", new awscdk_appsync_utils_1.ResolvableField({
            args: {
        ...
        props.appsyncApi.schema.addSubscription("onUpdatedEvent", new awscdk_appsync_utils_1.ResolvableField({
            returnType: events_object_Type.attribute(),
            dataSource: props.appsyncApi.noneDataSource,
            requestMappingTemplate: appsync.MappingTemplate.fromString(`{
                        "version": "2017-02-28",
