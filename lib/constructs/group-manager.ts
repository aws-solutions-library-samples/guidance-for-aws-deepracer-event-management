...
export class GroupManager extends Construct {
    ...
    constructor(scope: Construct, id: string, props: GroupManagerProps) {
        ...
        const postGroupsGroupUserFunction = new lambdaPython.PythonFunction( this, "postGroupsGroupUserFunction", {
        ...
        // Get groups Function
        const get_groups_function = new lambdaPython.PythonFunction(
            this,
            "get_groups_function", {
        ...
        // API RESOURCES
        const username_groupname_model =  props.restApi.api.addModel(
        ...
        apiAdminGroups.addMethod("GET",
            new apig.LambdaIntegration(get_groups_function), {
            authorizationType: apig.AuthorizationType.IAM,
        })

        // PUT /admin/groups
        apiAdminGroups.addMethod("PUT",
            new apig.LambdaIntegration(put_groups_group_function), {
            authorizationType: apig.AuthorizationType.IAM,
        })
        ...
        group.addMethod("GET",
            new apig.LambdaIntegration(get_groups_group_function), {
            authorizationType: apig.AuthorizationType.IAM,
        })

        // DELETE /admin/groups/{groupname}
        group.addMethod("DELETE",
            new apig.LambdaIntegration(delete_groups_group_function), {
            authorizationType: apig.AuthorizationType.IAM,
        })

        // POST /admin/groups/{groupname}
        group.addMethod("POST",
            new apig.LambdaIntegration(postGroupsGroupUserFunction), {
            authorizationType: apig.AuthorizationType.IAM,
        ...
        group_user.addMethod("DELETE",
            new apig.LambdaIntegration(deleteGroupsGroupUserFunction), {
            authorizationType: apig.AuthorizationType.IAM,
        })
    }
}
