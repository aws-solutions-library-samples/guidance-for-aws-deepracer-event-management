...
export class ModelsManager extends Construct {
    ...
    constructor(scope: Construct, id: string, props: ModelsManagerProps) {
        ...
        const delete_infected_files_function = new lambdaPython.PythonFunction(this, "delete_infected_files_function", {
        ...
        // Models Function
        const models_function = new lambdaPython.PythonFunction(
            this,
            "get_models_function", {
        ...
        const quarantined_models_function = new lambdaPython.PythonFunction(this, "get_quarantined_models_function", {
        ...
        const upload_model_to_car_function = new lambdaPython.PythonFunction(this, "upload_model_to_car_function", {
        ...
        // upload_model_to_car_function
        const upload_model_to_car_status_function = new lambdaPython.PythonFunction(this, "upload_model_to_car_status_function", {
        ...
        props.appsyncApi.schema.addQuery("getAllModels",
            new ResolvableField({
        ...
        props.appsyncApi.schema.addSubscription("updatedModel",
            new ResolvableField({
                returnType: model_object_type.attribute(),
                dataSource: props.appsyncApi.noneDataSource,
                requestMappingTemplate: appsync.MappingTemplate.fromString(
        ...
        // REST API
        const api_admin_quarantined_models = props.restApi.apiAdminResource.addResource( "quarantinedmodels" )

        api_admin_quarantined_models.addMethod("GET",
        ...
        api_models.addMethod("GET",
            new apig.LambdaIntegration(models_function),
            { authorizationType: apig.AuthorizationType.IAM },
        )
        ...
        apiCarsUploadResource.addMethod("POST",
        ...
        apiCarsUpload_status.addMethod("POST",
