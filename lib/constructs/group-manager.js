...
class GroupManager extends constructs_1.Construct {
    ...
    constructor(scope, id, props) {
        ...
        const get_groups_group_function = new lambdaPython.PythonFunction(this, "get_groups_group_function", {
        ...
        get_groups_group_function.addToRolePolicy(new iam.PolicyStatement({
        ...
        postGroupsGroupUserFunction.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
        ...
        const deleteGroupsGroupUserFunction = new lambdaPython.PythonFunction(this, "deleteGroupsGroupUserFunction", {
        ...
        deleteGroupsGroupUserFunction.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
        ...
        get_groups_function.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
        ...
        const put_groups_group_function = new lambdaPython.PythonFunction(this, "put_groups_group_function", {
        ...
        put_groups_group_function.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
        ...
        const delete_groups_group_function = new lambdaPython.PythonFunction(this, "delete_groups_group_function", {
        ...
        delete_groups_group_function.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
