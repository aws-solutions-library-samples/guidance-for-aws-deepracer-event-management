...
export class FleetsManager extends Construct {
    constructor(scope: Construct, id: string, props: FleetsManagerProps) {
        ...
        const fleets_table = new dynamodb.Table(
            this,
            "FleetsTable", {
            partitionKey: {
        ...
        const fleets_handler = new lambdaPython.PythonFunction(
            this,
            "fleetsFunction", {
        ...
        // Fleet methods
        props.appsyncApi.schema.addQuery( "getAllFleets",
            new ResolvableField({
                returnType: fleets_object_Type.attribute({ isList: true }),
                dataSource: fleets_data_source,
            }),
        )
        props.appsyncApi.schema.addMutation( "addFleet",
            new ResolvableField({
                args: {
        ...
        props.appsyncApi.schema.addSubscription( "onAddedFleet",
            new ResolvableField({
                returnType: fleets_object_Type.attribute(),
        ...
        props.appsyncApi.schema.addMutation( "deleteFleets",
            new ResolvableField({
        ...
        props.appsyncApi.schema.addSubscription( "onDeletedFleets",
            new ResolvableField({
                returnType: fleets_object_Type.attribute({ isList: true }),
                dataSource: props.appsyncApi.noneDataSource,
                requestMappingTemplate: appsync.MappingTemplate.fromString(
        ...
        props.appsyncApi.schema.addMutation( "updateFleet",
            new ResolvableField({
                args: {
        ...
        props.appsyncApi.schema.addSubscription( "onUpdatedFleet",
            new ResolvableField({
                returnType: fleets_object_Type.attribute(),
                dataSource: props.appsyncApi.noneDataSource,
                requestMappingTemplate: appsync.MappingTemplate.fromString(
