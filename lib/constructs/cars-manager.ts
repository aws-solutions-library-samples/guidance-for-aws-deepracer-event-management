...
export class CarManager extends Construct {
    ...
    constructor(scope: Construct, id: string, props: CarManagerProps) {
        ...
        const carsTable = new dynamodb.Table(
            this,
            "CarsStatusTable", {
            partitionKey: {
                name: "InstanceId",
        ...
        const describeInstanceInformationTask = new stepFunctionsTasks.CallAwsService(this,
        ...
        const definition = describeInstanceInformationTask.next(status_update_job).next(
        ...
        const car_status_update_SM = new stepFunctions.StateMachine(
            this, "CarStatusUpdater", { definition: definition, timeout: Duration.minutes(3) }
        )
        ...
        new awsEvents.Rule(
            ...
            targets: [
                new awsEventsTargets.SfnStateMachine(
        ...
        // Define API Schema
        const carActivationObjectType = new ObjectType(
            "carActivation", {
            definition: {
        ...
        props.appsyncApi.schema.addQuery("carsOnline",
            new ResolvableField({
                args: {
        ...
        props.appsyncApi.schema.addMutation("carUpdates",
            new ResolvableField({
                args: {
        ...
        props.appsyncApi.schema.addMutation(
            ...
            new ResolvableField({
                args: {
                    ...
                    "selectedColor": GraphqlType.string(
