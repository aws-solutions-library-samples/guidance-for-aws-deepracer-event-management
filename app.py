...
from aws_cdk import Environment, App, Aspects
...
if manual_deploy:
    print('Manual deploy')
    infrastructure = CdkDeepRacerEventManagerStack(app, "drem-backend-" + branchname + "-infrastructure", email=email, env=env)
