...
if os.path.exists(branch_file_name):
    ...
    sys.exit(
        "{} does not exist, please create and populate with the branch name you are"
        " working on.".format(branch_file_name)
    )
...
if os.path.exists(email_file_name):
    ...
    sys.exit(
        "{} does not exist, please create and populate with the admin email address."
