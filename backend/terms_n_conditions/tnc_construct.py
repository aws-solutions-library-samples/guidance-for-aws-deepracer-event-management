...
class TermsAndConditions(Construct):
    ...
    def __init__(self, scope: Construct, id: str, logs_bucket: s3.IBucket, distribution: cloudfront.Distribution, **kwargs):
        super().__init__(scope, id, **kwargs)

        stack = Stack.of(self)

        tnc_bucket = s3.Bucket(self, "TncBucket",
        ...
        s3_deployment.BucketDeployment(self, 'TncDeploy',
            sources= [
        ...
        origin_access_identity = cloudfront.OriginAccessIdentity(self, "TncOAI",
        ...
        distribution.add_behavior(
            path_pattern='terms_and_conditions.html',
            origin=tnc_origin
        )