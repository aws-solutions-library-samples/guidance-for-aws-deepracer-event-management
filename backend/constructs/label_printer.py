    ...
    def __init__(
        ...
        **kwargs,
        ...
        print_functions_layer = lambda_python.PythonLayerVersion(
            ...
            compatible_architectures=[base_stack._lambda_architecture],
            compatible_runtimes=[base_stack._lambda_runtime],
        ...
        print_label_function = lambda_python.PythonFunction(
            ...
            layers=[
                base_stack._helper_functions_layer,
                print_functions_layer,
                base_stack._powertools_layer,
            ],
            environment={
