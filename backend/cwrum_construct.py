...
class CwRumAppMonitor(Construct):
    def __init__(
        ...
        session_sample_rate: decimal = 1,
        telemetries: list = ["performance", "errors", "http"],
        **kwargs
    ):
        ...
        cognito.CfnIdentityPoolRoleAttachment(
            self,
            "CwRumIdentityPoolRoleAttachment",
        ...
        rum_policy = iam.PolicyStatement(
            ...
            resources=[
                "arn:aws:rum:{}:{}:appmonitor/{}".format(
                    stack.region, stack.account, cfn_app_monitor.ref
                )
            ],
        )
        ...
        rum_app_monitor_id = cwrum_custom_resource(self, name=cfn_app_monitor.ref)
